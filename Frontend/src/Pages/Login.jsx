      ...
      <div className="flex min-h-screen w-full flex-col bg-center relative">
        <div className="flex bg-blue-900 justify-between p-4 sm:p-6 z-10">
          ...
          <nav className="flex items-center gap-4">
            <button className="bg-white rounded-2xl text-indigo-900 text-sm px-4 py-2 sm:w-25 sm:h-10 
              hover:shadow-xl cursor-pointer border-2 border-indigo-950 font-bold" onClick={() => {setIsLoggedIn(true)}}>
              Sign Up
            </button>
          </nav>
        </div>
        <div className="flex flex-col items-center justify-center flex-grow w-full px-4">
          ...
          <div className="bg-blue-100 rounded-xl text-center w-[400px] h-[300px] flex flex-col 
          items-center relative z-10 mt-10">
            ...
            />
            <a href="#" className="text-xs font-bold text-blue-950 mt-2 block
            ">Forgot Password?</a>
            <button className="bg-blue-900 rounded-xl w-80 h-10 text-white font-bold mt-3 cursor-pointer">
              Sign In
            </button>
            <p className="text-xs mt-2 font-bold">
              Don't have an account? <a href="#" className="text-blue-900 pl-3">Sign Up</a>
            </p>
          </div>
        </div>
      </div>
